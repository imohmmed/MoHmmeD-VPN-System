...
export default function SubOwnerAgentDetailPage() {
  ...
  const paymentMutation = useMutation({
    mutationFn: (data: any) => apiRequest("POST", `/api/my-agents/${agentId}/payment`, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/my-agents", agentId] });
  ...
  const configsMutation = useMutation({
    mutationFn: (allowedConfigs: string[]) => apiRequest("PATCH", `/api/my-agents/${agentId}/configs`, { allowedConfigs }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/my-agents", agentId] });
  ...
  const suspendMutation = useMutation({
    mutationFn: () => apiRequest("PATCH", `/api/my-agents/${agentId}/suspend`),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/my-agents", agentId] });
      queryClient.invalidateQueries({ queryKey: ["/api/my-agents"] });
    ...
    return (
      <Layout title="Agent Not Found">
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <Button variant="ghost" className="mt-4" onClick={() => setLocation("/sub-owner/agents")}>
      ...
      <div className="space-y-6 max-w-5xl">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex items-center gap-4">
            <Button variant="ghost" size="icon" onClick={() => setLocation("/sub-owner/agents")} data-testid="button-back">
